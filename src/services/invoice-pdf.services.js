...
const formatFiatAmount = (fiatAmount, fiatDecimals, fiatCurrency) => {
 ...
 */
export const generateInvoicePdf = (invoice, merchant) => {
    return new Promise((resolve, reject) => {
        ...
        if (invoice.pricingMode === FIXED_FIAT &&
            invoice.fiatAmount !== null &&
            invoice.fiatCurrency !== null &&
            invoice.fiatDecimals !== null) {
            drawField(doc, 'Fiat amount:', formatFiatAmount(invoice.fiatAmount, invoice.fiatDecimals, invoice.fiatCurrency));
        }
